...
<prefab version="1.6.0">
	<group name="Laser" pos="0.0 0.0 0.0" rot="0.0 0.0 180.0">
		...
		<group name="Chamber" pos="0.0 0.0 0.3" rot="0.0 0.0 22.5">
			<vox pos="-0.12 -0.05 0.0" rot="0.0 0.0 0.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="-0.02 -0.05 0.0" rot="0.0 0.0 0.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="-0.04929 0.12071 0.0" rot="0.0 0.0 -90.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="0.05071 0.12071 0.0" rot="-180.0 -180.0 -45.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="0.12142 0.05 0.0" rot="180.0 180.0 0.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="0.12142 -0.05 0.0" rot="-180.0 180.0 45.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="0.05071 -0.12071 0.0" rot="0.0 360.0 90.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="-0.04929 -0.12071 0.0" rot="0.0 0.0 45.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
			<vox pos="-0.12 0.05 0.0" rot="0.0 0.0 -45.0" file="MOD/assets/models/tool.vox" object="chamberbit"/>
		</group>
		...
		<group name="Rim" pos="-0.154 -0.05 0.8">
			<vox file="MOD/assets/models/tool.vox" object="rimbit"/>
			<vox pos="0.05878 -0.0809 0.0" rot="0.0 0.0 36.0" file="MOD/assets/models/tool.vox" object="rimbit"/>
			<vox pos="0.15388 -0.1118 0.0" rot="0.0 0.0 72.0" file="MOD/assets/models/tool.vox" object="rimbit"/>
			<vox pos="0.24899 -0.0809 0.0" rot="-180.0 -180.0 72.0" file="MOD/assets/models/tool.vox" object="rimbit"/>
		...
		<group name="Rim" pos="-0.154 -0.05 0.35">
			<vox file="MOD/assets/models/tool.vox" object="rimbit"/>
			<vox pos="0.05878 -0.0809 0.0" rot="0.0 0.0 36.0" file="MOD/assets/models/tool.vox" object="rimbit"/>
			<vox pos="0.15388 -0.1118 0.0" rot="0.0 0.0 72.0" file="MOD/assets/models/tool.vox" object="rimbit"/>
			<vox pos="0.24899 -0.0809 0.0" rot="-180.0 -180.0 72.0" file="MOD/assets/models/tool.vox" object="rimbit"/>
		...
		<group name="Lens Rim" pos="-0.154 -0.05 -0.4">
			...
			<vox pos="-0.1 0.0 0.1" rot="90.0 35.0 0.0" file="MOD/assets/models/tool.vox" object="clampbit"/>
			<vox pos="0.10137 0.30137 0.1" rot="180.0 90.0 -55.0" file="MOD/assets/models/tool.vox" object="clampbit"/>
			<vox pos="0.40273 0.1 0.1" rot="-90.0 145.0 0.0" file="MOD/assets/models/tool.vox" object="clampbit"/>
			<vox pos="0.20137 -0.20137 0.1" rot="0.0 90.0 55.0" file="MOD/assets/models/tool.vox" object="clampbit"/>
		</group>
