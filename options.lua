...
function draw()
    UiPush()
        ...
        UiTranslate(0, 100)
        UiText('You can use your Grab (Hold it down) keybind and Use Tool keybind ingame to change laser modes')
        UiTranslate(0, 25)
        UiText('For console / steamdeck this defaults to Hold L2 + Tap R2')
        UiTranslate(0, 25)
        UiText('For desktop this defaults to Hold Rmb + Tap Lmb')
    UiPop()
end